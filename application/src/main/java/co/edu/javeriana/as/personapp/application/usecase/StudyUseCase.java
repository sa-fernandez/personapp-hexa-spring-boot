...
public class StudyUseCase implements StudyInputPort {
    ...
    public Study edit(Integer identificationProf, Integer identificationPer, Study study) throws NoExistException {
		...
		throw new NoExistException(
				"The study with idProf " + identificationProf + " and idPer " + identificationPer + " does not exist into db, cannot be edited");
    }
    ...
    public Boolean drop(Integer identificationProf, Integer identificationPer) throws NoExistException {
		...
		throw new NoExistException(
				"The study with idProf " + identificationProf + " and idPer " + identificationPer + " does not exist into db, cannot be deleted");
    }
    ...
    public Study findOne(Integer identificationProf, Integer identificationPer) throws NoExistException {
		...
		if (oldStudy != null)
			return oldStudy;
		throw new NoExistException(
				"The study with idProf " + identificationProf + " and idPer " + identificationPer + " does not exist into db, cannot be found");
    }
