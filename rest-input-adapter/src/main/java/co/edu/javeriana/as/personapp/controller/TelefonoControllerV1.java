...
public class TelefonoControllerV1 {
	...
	public TelefonoResponse editarPersona(@RequestBody TelefonoRequest request) {
	...
	public Boolean eliminarPersona(@PathVariable String database, @PathVariable String number) {
